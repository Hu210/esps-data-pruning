...
import math
import wandb
from data_subset import load_cifar100_sub, load_cifar10_sub, load_tiny_sub
...
wandb.init(project=f"{args.arch}_{args.dataset}_{args.method}", 
           name = f"{args.method}_{args.sample}_bsz{args.batch_size}_{args.keep}_{args.subset_rate}",
           config=args)
...
def main(): 
    ...
    if args.dataset == 'cifar10':
        ...
        args.num_samples = 100000 * args.subset_rate
        args.num_iter = math.ceil(args.num_samples / args.batch_size)
        train_loader, test_loader = load_tiny_sub(args, target_probs, score, mask)
